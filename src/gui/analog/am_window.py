...
class AMWindow(QWidget):
    ...
    def setup_ui(self):
        ...
        # PLOTS
        self.message_plot = pg.PlotWidget(title="Message Signal")

        self.carrier_plot = pg.PlotWidget(title="Carrier Signal")

        self.am_plot = pg.PlotWidget(title="AM Signal")

        main_layout.addWidget(self.message_plot)

        main_layout.addWidget(self.carrier_plot)

        main_layout.addWidget(self.am_plot)
        ...
        self.am_plot.showGrid(x=True, y=True)
    ...
    def update_inputs(self):
        ...
        self.mod_index_input.setText(
            str(self.mod_index_slider.value() / 100)
        )
    ...
    def update_sliders(self):
        ...
        try:
            ...
            self.mod_index_slider.setValue(
                int(float(self.mod_index_input.text()) * 100)
            )
